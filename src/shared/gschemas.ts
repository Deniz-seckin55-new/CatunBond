...
export const UserVariablesValidSchema = z.object({
    ...
    defaultZoomFactor: z.number().min(1).max(17).default(2),
    magnifyingGlassOnPreviews: z.boolean().default(true),
    showUsernamesUnderAvatarsInVoiceChats: z.boolean().default(false),
    mirrorCameraWhenShared: z.boolean().default(true),
});