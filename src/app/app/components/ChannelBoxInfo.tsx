import { Currents, ViewingFriendsDiv } from "../utils/utils";
...
const ChannelBoxInfo: React.FC<Props> = ({ Currents, setServerUsersDivV, ServerUsersDivV, onClickAddFriend, onClickFB }) => {
    const onClickUsers = () => {
        ...
        <>
            <div className={styles.channel_info_box_channel}>
                {(Currents.channel && !Currents.friendsdiv.visible) && (<>
                    ...
                    <button onClick={onClickUsers} className={styles.channel_info_box_users}>
