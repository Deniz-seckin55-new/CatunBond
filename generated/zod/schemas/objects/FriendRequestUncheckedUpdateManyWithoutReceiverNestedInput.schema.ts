...
const Schema: z.ZodType<Prisma.FriendRequestUncheckedUpdateManyWithoutReceiverNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const FriendRequestUncheckedUpdateManyWithoutReceiverNestedInputObjectSchema =
  Schema;
