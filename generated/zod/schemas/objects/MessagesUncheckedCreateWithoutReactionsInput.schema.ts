...
const Schema: z.ZodType<Prisma.MessagesUncheckedCreateWithoutReactionsInput> = z
  .object({
...
export const MessagesUncheckedCreateWithoutReactionsInputObjectSchema = Schema;
