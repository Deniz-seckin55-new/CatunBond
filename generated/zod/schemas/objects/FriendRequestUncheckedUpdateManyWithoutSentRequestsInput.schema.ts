...
const Schema: z.ZodType<Prisma.FriendRequestUncheckedUpdateManyWithoutSentRequestsInput> =
  z
    .object({
      id: z
        .union([
...
export const FriendRequestUncheckedUpdateManyWithoutSentRequestsInputObjectSchema =
  Schema;
