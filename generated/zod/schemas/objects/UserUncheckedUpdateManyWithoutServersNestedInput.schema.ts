...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateManyWithoutServersNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => UserUpsertWithWhereUniqueWithoutServersInputObjectSchema,
          ),
          z
            .lazy(
              () => UserUpsertWithWhereUniqueWithoutServersInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => UserUpdateWithWhereUniqueWithoutServersInputObjectSchema,
          ),
          z
            .lazy(
              () => UserUpdateWithWhereUniqueWithoutServersInputObjectSchema,
...
export const UserUncheckedUpdateManyWithoutServersNestedInputObjectSchema =
  Schema;
