...
const Schema: z.ZodType<Prisma.UserUncheckedCreateNestedManyWithoutServersInput> =
  z
    .object({
      create: z
        .union([
...
export const UserUncheckedCreateNestedManyWithoutServersInputObjectSchema =
  Schema;
