...
const Schema: z.ZodType<Prisma.FriendRequestUncheckedUpdateManyWithoutReceivedRequestsInput> =
  z
    .object({
      id: z
        .union([
...
export const FriendRequestUncheckedUpdateManyWithoutReceivedRequestsInputObjectSchema =
  Schema;
