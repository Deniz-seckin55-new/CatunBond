...
const Schema: z.ZodType<Prisma.UserUncheckedCreateNestedManyWithoutFriendOfInput> =
  z
    .object({
      create: z
        .union([
...
export const UserUncheckedCreateNestedManyWithoutFriendOfInputObjectSchema =
  Schema;
