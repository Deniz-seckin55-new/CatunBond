...
const Schema: z.ZodType<Prisma.ReactionUpdateManyWithoutMessageNestedInput> = z
  .object({
    create: z
      .union([
...
export const ReactionUpdateManyWithoutMessageNestedInputObjectSchema = Schema;
