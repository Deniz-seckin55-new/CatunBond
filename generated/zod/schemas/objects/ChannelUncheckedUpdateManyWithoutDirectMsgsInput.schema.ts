...
const Schema: z.ZodType<Prisma.ChannelUncheckedUpdateManyWithoutDirectMsgsInput> =
  z
    .object({
      id: z
        .union([
...
export const ChannelUncheckedUpdateManyWithoutDirectMsgsInputObjectSchema =
  Schema;
