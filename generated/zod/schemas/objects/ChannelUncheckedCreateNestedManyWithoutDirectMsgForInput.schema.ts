...
const Schema: z.ZodType<Prisma.ChannelUncheckedCreateNestedManyWithoutDirectMsgForInput> =
  z
    .object({
      create: z
        .union([
...
export const ChannelUncheckedCreateNestedManyWithoutDirectMsgForInputObjectSchema =
  Schema;
