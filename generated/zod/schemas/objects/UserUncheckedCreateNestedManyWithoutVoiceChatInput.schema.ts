...
const Schema: z.ZodType<Prisma.UserUncheckedCreateNestedManyWithoutVoiceChatInput> =
  z
    .object({
      create: z
        .union([
...
export const UserUncheckedCreateNestedManyWithoutVoiceChatInputObjectSchema =
  Schema;
