...
const Schema: z.ZodType<Prisma.MessagesUpdateManyWithoutChannelNestedInput> = z
  .object({
    create: z
      .union([
...
export const MessagesUpdateManyWithoutChannelNestedInputObjectSchema = Schema;
