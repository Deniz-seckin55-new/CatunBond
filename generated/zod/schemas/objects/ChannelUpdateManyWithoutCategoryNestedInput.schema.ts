...
const Schema: z.ZodType<Prisma.ChannelUpdateManyWithoutCategoryNestedInput> = z
  .object({
    create: z
      .union([
...
export const ChannelUpdateManyWithoutCategoryNestedInputObjectSchema = Schema;
