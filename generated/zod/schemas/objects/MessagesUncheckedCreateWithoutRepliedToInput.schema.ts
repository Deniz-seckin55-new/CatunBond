...
const Schema: z.ZodType<Prisma.MessagesUncheckedCreateWithoutRepliedToInput> = z
  .object({
...
export const MessagesUncheckedCreateWithoutRepliedToInputObjectSchema = Schema;
