...
const Schema: z.ZodType<Prisma.ServerUncheckedCreateNestedManyWithoutMembersInput> =
  z
    .object({
      create: z
        .union([
...
export const ServerUncheckedCreateNestedManyWithoutMembersInputObjectSchema =
  Schema;
