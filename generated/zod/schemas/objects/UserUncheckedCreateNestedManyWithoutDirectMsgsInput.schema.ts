...
const Schema: z.ZodType<Prisma.UserUncheckedCreateNestedManyWithoutDirectMsgsInput> =
  z
    .object({
      create: z
        .union([
...
export const UserUncheckedCreateNestedManyWithoutDirectMsgsInputObjectSchema =
  Schema;
