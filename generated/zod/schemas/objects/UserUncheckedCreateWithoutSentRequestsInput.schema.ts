...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutSentRequestsInput> = z
  .object({
    id: z.string(),
    username: z.string(),
...
export const UserUncheckedCreateWithoutSentRequestsInputObjectSchema = Schema;
