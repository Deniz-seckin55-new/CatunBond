...
const Schema: z.ZodType<Prisma.UserUpdateManyWithoutDirectMsgsNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => UserUpdateManyWithWhereWithoutDirectMsgsInputObjectSchema),
        z
          .lazy(() => UserUpdateManyWithWhereWithoutDirectMsgsInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const UserUpdateManyWithoutDirectMsgsNestedInputObjectSchema = Schema;
