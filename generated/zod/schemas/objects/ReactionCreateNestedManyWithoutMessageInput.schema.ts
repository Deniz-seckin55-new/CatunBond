...
const Schema: z.ZodType<Prisma.ReactionCreateNestedManyWithoutMessageInput> = z
  .object({
    create: z
      .union([
...
export const ReactionCreateNestedManyWithoutMessageInputObjectSchema = Schema;
