...
const Schema: z.ZodType<Prisma.UserUpdateManyWithoutVoiceChatNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => UserUpdateManyWithWhereWithoutVoiceChatInputObjectSchema),
        z
          .lazy(() => UserUpdateManyWithWhereWithoutVoiceChatInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const UserUpdateManyWithoutVoiceChatNestedInputObjectSchema = Schema;
