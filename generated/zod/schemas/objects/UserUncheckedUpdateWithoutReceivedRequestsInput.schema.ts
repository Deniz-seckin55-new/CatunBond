...
import { MessagesUncheckedUpdateManyWithoutAuthorNestedInputObjectSchema } from './MessagesUncheckedUpdateManyWithoutAuthorNestedInput.schema';
...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutReceivedRequestsInput> =
  z
    .object({
      id: z
        .union([
      ...
      messages: z
        .lazy(
          () => MessagesUncheckedUpdateManyWithoutAuthorNestedInputObjectSchema,
        )
        .optional(),
      directMsgs: z
        .lazy(
      ...
      friends: z
        .lazy(
          () => UserUncheckedUpdateManyWithoutFriendOfNestedInputObjectSchema,
        )
        .optional(),
      friendOf: z
        .lazy(
...
export const UserUncheckedUpdateWithoutReceivedRequestsInputObjectSchema =
  Schema;
