...
const Schema: z.ZodType<Prisma.ServerListOrderElementUncheckedCreateNestedManyWithoutUserInfoInput> =
  z
    .object({
      create: z
        .union([
...
export const ServerListOrderElementUncheckedCreateNestedManyWithoutUserInfoInputObjectSchema =
  Schema;
