...
const Schema: z.ZodType<Prisma.FriendRequestUncheckedCreateNestedManyWithoutReceiverInput> =
  z
    .object({
      create: z
        .union([
...
export const FriendRequestUncheckedCreateNestedManyWithoutReceiverInputObjectSchema =
  Schema;
