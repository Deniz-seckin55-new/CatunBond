...
import { ChannelUncheckedCreateNestedManyWithoutDirectMsgForInputObjectSchema } from './ChannelUncheckedCreateNestedManyWithoutDirectMsgForInput.schema';
...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutReceivedRequestsInput> =
  z
    .object({
      id: z.string(),
      username: z.string(),
      ...
      directMsgs: z
        .lazy(
          () =>
            ChannelUncheckedCreateNestedManyWithoutDirectMsgForInputObjectSchema,
        )
        .optional(),
      friends: z
        .lazy(
          () => UserUncheckedCreateNestedManyWithoutFriendOfInputObjectSchema,
        )
        .optional(),
      friendOf: z
        .lazy(
...
export const UserUncheckedCreateWithoutReceivedRequestsInputObjectSchema =
  Schema;
