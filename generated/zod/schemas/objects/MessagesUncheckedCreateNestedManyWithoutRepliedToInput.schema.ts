...
const Schema: z.ZodType<Prisma.MessagesUncheckedCreateNestedManyWithoutRepliedToInput> =
  z
    .object({
      create: z
        .union([
...
export const MessagesUncheckedCreateNestedManyWithoutRepliedToInputObjectSchema =
  Schema;
