...
const Schema: z.ZodType<Prisma.MessagesUpdateManyWithoutRepliedToNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const MessagesUpdateManyWithoutRepliedToNestedInputObjectSchema = Schema;
