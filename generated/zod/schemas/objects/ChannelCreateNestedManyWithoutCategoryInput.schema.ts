...
const Schema: z.ZodType<Prisma.ChannelCreateNestedManyWithoutCategoryInput> = z
  .object({
    create: z
      .union([
...
export const ChannelCreateNestedManyWithoutCategoryInputObjectSchema = Schema;
