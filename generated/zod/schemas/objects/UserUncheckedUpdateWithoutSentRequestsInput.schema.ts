...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutSentRequestsInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const UserUncheckedUpdateWithoutSentRequestsInputObjectSchema = Schema;
