...
const Schema: z.ZodType<Prisma.MessagesUncheckedCreateNestedManyWithoutChannelInput> =
  z
    .object({
      create: z
        .union([
...
export const MessagesUncheckedCreateNestedManyWithoutChannelInputObjectSchema =
  Schema;
