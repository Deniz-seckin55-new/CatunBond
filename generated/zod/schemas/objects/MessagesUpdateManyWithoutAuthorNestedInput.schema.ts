...
const Schema: z.ZodType<Prisma.MessagesUpdateManyWithoutAuthorNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => MessagesUpdateManyWithWhereWithoutAuthorInputObjectSchema),
        z
          .lazy(() => MessagesUpdateManyWithWhereWithoutAuthorInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const MessagesUpdateManyWithoutAuthorNestedInputObjectSchema = Schema;
