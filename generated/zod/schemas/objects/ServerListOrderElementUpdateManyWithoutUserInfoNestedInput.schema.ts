...
const Schema: z.ZodType<Prisma.ServerListOrderElementUpdateManyWithoutUserInfoNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ServerListOrderElementUpdateManyWithoutUserInfoNestedInputObjectSchema =
  Schema;
