...
const Schema: z.ZodType<Prisma.NestedEnumFriendRequestStatusWithAggregatesFilter> =
  z
    .object({
...
export const NestedEnumFriendRequestStatusWithAggregatesFilterObjectSchema =
  Schema;
