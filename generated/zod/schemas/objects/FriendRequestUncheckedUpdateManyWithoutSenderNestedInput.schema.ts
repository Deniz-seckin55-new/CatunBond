...
const Schema: z.ZodType<Prisma.FriendRequestUncheckedUpdateManyWithoutSenderNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const FriendRequestUncheckedUpdateManyWithoutSenderNestedInputObjectSchema =
  Schema;
