...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateManyWithoutFriendOfNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => UserUpsertWithWhereUniqueWithoutFriendOfInputObjectSchema,
          ),
          z
            .lazy(
              () => UserUpsertWithWhereUniqueWithoutFriendOfInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => UserUpdateWithWhereUniqueWithoutFriendOfInputObjectSchema,
          ),
          z
            .lazy(
              () => UserUpdateWithWhereUniqueWithoutFriendOfInputObjectSchema,
...
export const UserUncheckedUpdateManyWithoutFriendOfNestedInputObjectSchema =
  Schema;
