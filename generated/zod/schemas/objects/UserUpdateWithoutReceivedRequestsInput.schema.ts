...
import { FriendRequestUpdateManyWithoutSenderNestedInputObjectSchema } from './FriendRequestUpdateManyWithoutSenderNestedInput.schema';
...
const Schema: z.ZodType<Prisma.UserUpdateWithoutReceivedRequestsInput> = z
  .object({
    id: z
      .union([
        z.string(),
    ...
    auth: z
      ...
      .optional(),
    sentRequests: z
      .lazy(() => FriendRequestUpdateManyWithoutSenderNestedInputObjectSchema)
      .optional(),
    messages: z
...
export const UserUpdateWithoutReceivedRequestsInputObjectSchema = Schema;
