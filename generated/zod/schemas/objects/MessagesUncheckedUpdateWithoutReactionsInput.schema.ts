...
const Schema: z.ZodType<Prisma.MessagesUncheckedUpdateWithoutReactionsInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const MessagesUncheckedUpdateWithoutReactionsInputObjectSchema = Schema;
