...
const Schema: z.ZodType<Prisma.ServerUpdateManyWithoutMembersNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => ServerUpdateManyWithWhereWithoutMembersInputObjectSchema),
        z
          .lazy(() => ServerUpdateManyWithWhereWithoutMembersInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const ServerUpdateManyWithoutMembersNestedInputObjectSchema = Schema;
